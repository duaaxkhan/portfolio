...
const Navbar = () => {
  ...
  return (
        ...
        <div className='fixed w-full h-[80px] flex justify-between px-4 items-center bg-[#000000] text-[#d9d9d9]'>
            ...
            {/* Mobile Menu */}
            <div className={!nav?'hidden':' absolute top-0 left-0 w-full bg-cover  h-screen bg-[#000000] flex flex-col justify-center items-center'}>
            <ul>
          ...
          <li className='w-[160px] h-[60px] flex justify-between items-center ml-[-100px] hover:ml-[-10px] duration-300 bg-[#565f69]'>
            <a
              className='flex justify-between items-center w-full text-gray-300'
              href='https://drive.google.com/file/d/1VWBejeAu37KYai4U42zzh2_-VGBIXtlo/view?usp=sharing'
            >
