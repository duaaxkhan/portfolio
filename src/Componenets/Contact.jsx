...
export const Contact = () => {
  return (
    <div name="contact" className='w-full h-screen bg-[#191616] flex justify-center items-center p-4'>
       <form method='POST' action="https://getform.io/f/ebpdelvb" className='flex flex-col max-w-[600px] w-full'>
            <div className='pb-8'>
                <p className='text-4xl font-bold inline border-b-4 border-[#fcc0c5] text-[#9b9ea7] '>Contact</p>
